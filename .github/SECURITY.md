...
Kairo LSP uses [semantic versioning](https://semver.org/) for its releases. The version number is formatted as `MAJOR.MINOR.PATCH`, where:
...
- **Email:** [security@kairolang.com](mailto:security@kairolang.com)
...
For any further questions or concerns regarding our security policy, please contact us at [security@kairolang.com](mailto:security@kairolang.com).
